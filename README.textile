...
By default this method will display a warning and redirect to the @root_path@. However, if want somet other behavior, just redefine this
...
@User::Role.to_options@. Pass @false@ as a parameter to remove the defaul @-- Choose Role --@ option. Or you can pass
...
responds to the super user stuff, so if you don't want to use it, you don't have to.
